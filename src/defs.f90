...
module defs
  ...
  ! Laurent Modification: units for gaussian interaction
  ...
  ! Laurent Modification: added more atom types so we can just follow the periodic table
  character(len=5), dimension(10)             :: type_name
